...
![Rouqi Luxury Perfumes Store Banner](public/banner.svg)

# Rouqi Luxury Perfumes Store
### عطور الروقي الفاخرة

[![Project ID](https://img.shields.io/badge/Project_ID-sd-04-rouqi-perfumes-06b6d4.svg?style=for-the-badge)]()
...
**🇸🇦 متجر إلكتروني فاخر للعطور الشرقية والغربية، مزود بمكتشف العطور التفاعلي، وتحليل المكونات، وسلة التسوق وخيارات الهدايا الفاخرة.**  
**🇺🇸 An exclusive oriental & western fragrance e-commerce store with interactive scent finder, notes breakdown, shopping cart, and luxury gifting options.**
...
يمثل مشروع **عطور الروقي الفاخرة** تطبيق ويب حديث وفاخر تم تطويره ليكون نموذجاً احترافياً ريادياً في قطاع **التجارة الإلكترونية الفاخرة وصناعة العطور الشرقية والغربية**.

- **قطاع الأعمال**: التجارة الإلكترونية الفاخرة وصناعة العطور الشرقية والغربية
- **فلسفة التصميم**: تعتمد الفلسفة البصرية على السلاسة، والجماليات العصرية، مع استخدام الألوان المناسبة للقطاع (**Burgundy & Amber Gold / بورغندي ملكي وعنبر ذهبي**)، وتحقيق أقصى درجات تجربة المستخدم (UX).
...
**Rouqi Luxury Perfumes Store** is a state-of-the-art web application developed to demonstrate production-grade engineering in the **Luxury E-Commerce & Oriental Fragrances** sector.

- **Business Sector**: Luxury E-Commerce & Oriental Fragrances
- **Design Philosophy**: Built around visual elegance, high-contrast typography, tailored color schemes (**Burgundy & Amber Gold / بورغندي ملكي وعنبر ذهبي**), and intuitive user interaction flows.
...
- ✔ **متجر إلكتروني متكامل بتصاميم مخملية وألوان فخمة تناسب أرقى المنتجات العطرية.**
- ✔ **تصفية ديناميكية للمنتجات حسب العائلات العطرية، الأسعار، وعطور الرجال والنساء.**
- ✔ **شرح تفصيلي للمكونات العطرية (القمة، القلب، القاعدة) بأسلوب جذاب وبصري.**
- ✔ **سلة تسوق تفاعلية سريعة تتيح تعديل الكميات وحساب الإجمالي لحظياً.**
- ✔ **دعم كامل للغتين العربية والإنجليزي مع مرونة كاملة في التصفح بين الأجهزة.**

## 🇺🇸 English

- ✔ **Comprehensive luxury e-commerce store with velvet tones crafted for niche fragrances.**
- ✔ **Dynamic product filtering by fragrance notes, price range, and gender suitability.**
- ✔ **Visual scent breakdown detailing top notes, heart notes, and base notes for each item.**
- ✔ **Interactive real-time shopping cart drawer with instant quantity calculations.**
- ✔ **Flawless bilingual interface with fluid transition across mobile and desktop devices.**
...
تم بناء الهوية البصرية لمشروع **عطور الروقي الفاخرة** لتعكس الاحترافية العالية والدقة الشديدة:
- **نظام الألوان**: اختيار وتنسيق ألوان **Burgundy & Amber Gold / بورغندي ملكي وعنبر ذهبي** لخلق انطباع مبهر وفخم.
...
The design system for **Rouqi Luxury Perfumes Store** is engineered around premium aesthetics:
- **Palette**: Mastered palette around **Burgundy & Amber Gold / بورغندي ملكي وعنبر ذهبي** evoking trust, prestige, and focus.
...
- **`/`**: الصفحة الرئيسية - عروض العطور الحصرية وتشكيلة الموسم الملكية
- **`/shop`**: متجر العطور - تصفية حسب العائلة العطرية (عود، عنبر، زهور) والأسعار
- **`/product/[id]`**: تفاصيل العطر - تحليل النوتات العطرية العليا والوسطى والقاعدة وخيارات الحجم
- **`/about`**: عن العلامة - تاريخ صناعة العطور ونقاء الزيوت العطرية والمصادر
- **`/contact`**: التواصل والاستفسارات - خدمة العملاء والاستفسار عن المبيعات والجملة

## 🇺🇸 English

- **`/`**: Home Page - Exclusive seasonal fragrance collections, hero banner, and bestsellers
- **`/shop`**: Fragrance Shop - Dynamic filter by fragrance family (Oud, Amber, Floral) & price range
- **`/product/[id]`**: Product Details - Top, heart, and base notes breakdown with bottle volume selector
- **`/about`**: Brand Story - Perfumery heritage, rare ingredient sourcing, and artisan craftsmanship
- **`/contact`**: Contact & Support - Customer care, wholesale inquiries, and luxury gift packing
...
git clone https://github.com/malsalimi/sd-04-rouqi-perfumes.git
